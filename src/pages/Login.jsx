            ...
            <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    className="w-full bg-white/5 border border-white/10 p-6 pl-16 rounded-3xl outline-none focus:border-accent/40 focus:bg-white/[0.08] transition-all text-white font-bold"
              ...
              <button
                disabled={loading}
                className="w-full btn btn-primary py-6 rounded-3xl flex items-center justify-center gap-3 group text-sm"
              >
